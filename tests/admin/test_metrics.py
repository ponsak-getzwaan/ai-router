...
class TestPipelineMetrics:
    async def test_returns_200(self, ctx: AdminCtx) -> None:
        resp = await ctx.client.get("/admin/metrics/pipeline")
    ...
    async def test_period_minutes_defaults_to_60(self, ctx: AdminCtx) -> None:
        await ctx.client.get("/admin/metrics/pipeline")
    ...
    async def test_custom_period_is_forwarded(self, ctx: AdminCtx) -> None:
        await ctx.client.get("/admin/metrics/pipeline?period_minutes=30")
    ...
    async def test_period_below_minimum_returns_422(self, ctx: AdminCtx) -> None:
        resp = await ctx.client.get("/admin/metrics/pipeline?period_minutes=1")
        assert resp.status_code == 422

    async def test_period_above_maximum_returns_422(self, ctx: AdminCtx) -> None:
        resp = await ctx.client.get("/admin/metrics/pipeline?period_minutes=9999")
        assert resp.status_code == 422
...
class TestBouncerMetrics:
    async def test_returns_200(self, ctx: AdminCtx) -> None:
        resp = await ctx.client.get("/admin/metrics/bouncer")
        assert resp.status_code == 200
    ...
    async def test_period_forwarded(self, ctx: AdminCtx) -> None:
        await ctx.client.get("/admin/metrics/bouncer?period_minutes=120")
...
class TestClassifierMetrics:
    async def test_returns_200(self, ctx: AdminCtx) -> None:
        resp = await ctx.client.get("/admin/metrics/classifier")
        assert resp.status_code == 200
...
class TestRedactionMetrics:
    async def test_returns_200(self, ctx: AdminCtx) -> None:
        resp = await ctx.client.get("/admin/metrics/redaction")
        assert resp.status_code == 200
    ...
    async def test_period_forwarded(self, ctx: AdminCtx) -> None:
        await ctx.client.get("/admin/metrics/redaction?period_minutes=360")
